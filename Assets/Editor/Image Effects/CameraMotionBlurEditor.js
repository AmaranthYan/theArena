...
{	
  ...
  var preview_CMB : SerializedProperty;
  ...
  //var dynamicLayers : SerializedProperty;
    ...
    preview_CMB = serObj.FindProperty ("preview");
  ...
  function OnInspectorGUI () {         
    ...
    EditorGUILayout.PropertyField (preview_CMB, new GUIContent("Preview"));
    if (preview_CMB.boolValue)
